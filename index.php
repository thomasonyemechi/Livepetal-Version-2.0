...
<head>
    ...
    <meta name="author" content="Livepetal System" />
    <meta name="description" content="Livepetal Systems - Your Prefered digital marketplace" />
    <meta name="keywords" content="Software, , DSAThemes, One Page, Landing, Software, Mobile App, SaaS, Startup, Creative, Freelancers, Digital Product">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <!-- SITE TITLE -->
    <title>Livepetal | Your Prefered digital marketplace</title>
...
<body>
    ...
    <div id="page" class="page">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="hero-4-txt white-color">
                            ...
                            <!-- Title -->
                            <h2 class="h2-lg">Create your unique website with OLMO in just few hours</h2>

                            <!-- List -->
                            <ul class="simple-list">

                                <li class="list-item">
                                    <p class="p-xl">Fringilla risus, luctus mauris orci auctor purus a ligula undo euismod
                                        pretium purus pretium rutrum tempor sapien ligula undo auctor mauris
                                    </p>
                                </li>

                                <li class="list-item">
                                    <p class="p-xl">Nemo ipsam egestas volute turpis dolores aliquam quaerat sodales
                    ...
                    <div class="col-md-6 col-xl-5 offset-xl-1">
                        <div id="hero-4-form">
                            ...
                            <!-- Title -->
                            <h4 class="h4-xs">Convert your ideas into workable solutions</h4>
                            ...
                            <form name="requestForm" class="row request-form">
                                ...
                                <div class="col-md-12 form-btn mt-10">
                                    <button type="submit" class="btn btn-md btn-pink tra-grey-hover submit">Get Started Now</button>
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="section-title title-02 mb-85">
                            ...
                            <!-- Title -->
                            <h2 class="h2-xs">The best designed elements to make your site look modern</h2>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7 col-lg-6">
                            <div class="txt-block right-column wow fadeInLeft">
                                ...
                                <!-- Title -->
                                <h2 class="h2-xs">Lightning fast and super powerful</h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="section-title title-01 mb-80">
                            ...
                            <!-- Title -->
                            <h2 class="h2-md">Core Features That Matters</h2>
                        ...
                        <div class="col">
                            <div class="fbox-3 pc-15 mb-40 wow fadeInUp">
                                ...
                                <div class="fbox-txt-center">
                                    ...
                                    <!-- Text -->
                                    <p class="p-lg">Porta semper lacus cursus feugiat primis ultrice ligula risus an auctor
                ...
                <div class="row">
                    <div class="col">
                        <div class="more-btn mt-20">
                            <a href="projects.html" class="btn btn-pink tra-grey-hover">View More Projects</a>
                        </div>
                    </div>
        ...
        <!-- CONTENT-10
			============================================= -->
        <section id="content-10" class="content-10 bg-whitesmoke-gradient wide-100 content-section division">
            <div class="container">
                            ...
                            <div class="owl-carousel owl-theme reviews-4-wrapper">
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <p class="p-lg">Etiam sapien sagittis congue augue massa varius egestas ultrice
                                            varius magna undo tempus aliquet undo cursus suscipit cubilia laoreet augue
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">At sagittis congue augue egestas magna ipsum vitae a purus ipsum primis
                                            in cubilia laoreet augue egestas luctus and donec ultrice ligula magna at suscipit lectus gestas augue into cubilia
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">Mauris donec magnis sapien sapien congue augue egestas et ultrice
                                            vitae purus diam integer congue magna ligula undo egestas magna suscipit
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">Mauris donec a magnis sapien etiam sapien undo congue augue pretium
                                            ligula lectus aenean ipsum magna undo mauris lectus laoreet tempor
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">Laoreet magna a suscipit egestas lectus ultrice and purus ipsum
                                            primis and augue ligula egestas lectus gestas undo auctor tempus feugiat impedit
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">An augue cubilia laoreet undo magna ipsum and semper suscipit egestas magna
                                            ipsum ligula vitae purus and ipsum primis cubilia magna suscipit
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">Blandit vitae augue egestas diam tempus volutpat egestas augue in cubilia
                                            laoreet magna a suscipit luctus dolor and purus diam tempus undo aliquet porta rutrum gestas ipsum ligula a vitae purus
                                        </p>
                                ...
                                <div class="review-4">
                                    ...
                                    <div class="review-4-txt">
                                        ...
                                        <!-- Text -->
                                        <p class="p-lg">Augue at vitae purus tempus egestas volutpat an augue undo cubilia laoreet
        ...
        <!-- CALL TO ACTION-10
			============================================= -->
        <section id="cta-10" class="bg-04 pt-50 pb-50 cta-section division">
            <div class="container white-color">
                <div class="cta-10-wrapper">
                    <div class="row d-flex align-items-center">


                        <!-- CALL TO ACTION TEXT -->
                        <div class="col-lg-8 col-xl-7">
                            <div class="cta-10-txt">

                                <!-- Title -->
                                <h3 class="h3-md">Get started with OLMO for Free. It's fast and very easy!</h3>

                                <!-- Text -->
                                <p class="p-lg">Donec vel sapien augue integer urna vel turpis cursus porta, mauris
                                    augue luctus dolor velna auctor congue tempus integer pretium
                                </p>

                                <!-- Button -->
                                <a href="pricing.html" class="btn btn-pink tra-white-hover">Get Started Now</a>
                        ...
                        <div class="col-lg-4 col-xl-5">
                            <div class="text-end">
                                <div class="cta-10-img text-center">
                                    <img class="img-fluid" src="images/img-25.png" alt="cta-image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="section-title title-01 mb-70">
                            ...
                            <!-- Title -->
                            <h2 class="h2-md">Our Stories & Latest News</h2>
                        ...
                        <form class="newsletter-form">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-pink black-hover">Subscribe Now</button>
                                </span>
                            </div>
